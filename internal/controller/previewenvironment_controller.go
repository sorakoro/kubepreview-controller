...
const (
	finalizerName = "preview.kubepreview.dev/cleanup"
...
// +kubebuilder:rbac:groups=preview.kubepreview.dev,resources=previewenvironments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=preview.kubepreview.dev,resources=previewenvironments/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=preview.kubepreview.dev,resources=previewenvironments/finalizers,verbs=update
...
func (r *PreviewEnvironmentReconciler) reconcileDeployment(ctx context.Context, pe *previewv1alpha1.PreviewEnvironment, sourceName string) (bool, error) {
	...
	result, err := controllerutil.CreateOrUpdate(ctx, r.Client, preview, func() error {
		...
		preview.Labels["preview.kubepreview.dev/identifier"] = pe.Spec.Identifier
		preview.Labels["preview.kubepreview.dev/source-deployment"] = sourceName
...
func (r *PreviewEnvironmentReconciler) reconcileService(ctx context.Context, pe *previewv1alpha1.PreviewEnvironment, sourceName string) error {
	...
	result, err := controllerutil.CreateOrUpdate(ctx, r.Client, preview, func() error {
		...
		preview.Labels["preview.kubepreview.dev/identifier"] = pe.Spec.Identifier
		preview.Labels["preview.kubepreview.dev/source-service"] = sourceName
...
func (r *PreviewEnvironmentReconciler) reconcileVirtualService(ctx context.Context, pe *previewv1alpha1.PreviewEnvironment) error {
	...
	result, err := controllerutil.CreateOrUpdate(ctx, r.Client, vs, func() error {
		...
		vs.Labels["preview.kubepreview.dev/identifier"] = pe.Spec.Identifier
...
func (r *PreviewEnvironmentReconciler) cleanupResources(ctx context.Context, pe *previewv1alpha1.PreviewEnvironment) error {
	...
	if err := r.List(ctx, deploymentList,
		...
		client.MatchingLabels{"preview.kubepreview.dev/identifier": pe.Spec.Identifier},
	); err != nil {
		return err
	}
